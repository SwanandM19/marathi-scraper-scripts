...
# # ✅ CHANGE 1: Target increased from 20 → 23
# TARGET_SCRIPTS = 23
...
# # ✅ CHANGE 2: Regional section URL patterns to ignore
# SKIP_URL_PATTERNS = [
#     'javascript:', 'mailto:', '#',
#     '/category/', '/tag/', '/author/',
#     'facebook.com', 'twitter.com', 'instagram.com',
...
# # ============================================================
# # News Sites  ✅ CHANGE 1: targets updated (4+5+5+5+4 = 23)
# # ============================================================
# NEWS_SITES = [
#     {
#         "name": "TV9 Marathi",
...
#                     # ✅ CHANGE 2: Uses centralized SKIP_URL_PATTERNS
#                     # which now includes /north, /south, /west, /east
#                     # and all regional section paths
#                     if (15 < len(title) < 300 and
#                         site['link_pattern'] in href and
...
#     print("=" * 70)
#     print("🚀 JABARI KHABRI - SMART NEWS SCRAPER v11.0")
#     print(f"🔍 Analysis : {ANALYSIS_MODEL}")
#     print(f"✍️  Scripts  : {SCRIPT_MODEL}")
#     print(f"🎯 Target   : {TARGET_SCRIPTS} scripts")
#     print(f"🕐 Timezone : IST (Asia/Kolkata)")
